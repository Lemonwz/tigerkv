...
const (
	...
	// 'MessageType_MsgAppendRelay' contains log entries to replicate from leader to relay.
	MessageType_MsgAppendRelay MessageType = 13
	// 'MessageType_MsgAppendRelayResponse' is response to log replication request('MessageType_MsgAppendRelay').
	MessageType_MsgAppendRelayResponse MessageType = 14
)
...
type Message struct {
	...
	HintIndex            uint64      `protobuf:"varint,11,opt,name=hint_index,json=hintIndex,proto3" json:"hint_index,omitempty"`
	HintTerm             uint64      `protobuf:"varint,12,opt,name=hint_term,json=hintTerm,proto3" json:"hint_term,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *Message) GetHintIndex() uint64 {
	if m != nil {
		return m.HintIndex
	}
	return 0
...
func (m *Message) GetHintTerm() uint64 {
	if m != nil {
		return m.HintTerm
	}
	return 0
...
type ConfState struct {
	...
	// peer group number
	PeerGroupNum         uint64   `protobuf:"varint,2,opt,name=peer_group_num,json=peerGroupNum,proto3" json:"peer_group_num,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ConfState) GetPeerGroupNum() uint64 {
	if m != nil {
		return m.PeerGroupNum
	}
	return 0
}
...
var fileDescriptor_acd9f78e51523dd8 = []byte{
	...
	,
}
...
func (m *Message) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.HintTerm != 0 {
		i = encodeVarintEraftpb(dAtA, i, uint64(m.HintTerm))
		i--
		dAtA[i] = 0x60
	}
	if m.HintIndex != 0 {
		i = encodeVarintEraftpb(dAtA, i, uint64(m.HintIndex))
		i--
		dAtA[i] = 0x58
	}
	if m.Reject {
...
func (m *ConfState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.PeerGroupNum != 0 {
		i = encodeVarintEraftpb(dAtA, i, uint64(m.PeerGroupNum))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Nodes) > 0 {
...
func (m *Message) Size() (n int) {
	...
	if m.HintIndex != 0 {
		n += 1 + sovEraftpb(uint64(m.HintIndex))
	}
	if m.HintTerm != 0 {
		n += 1 + sovEraftpb(uint64(m.HintTerm))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *ConfState) Size() (n int) {
	...
	if m.PeerGroupNum != 0 {
		n += 1 + sovEraftpb(uint64(m.PeerGroupNum))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HintIndex", wireType)
			}
			m.HintIndex = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HintIndex |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HintTerm", wireType)
			}
			m.HintTerm = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HintTerm |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ConfState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PeerGroupNum", wireType)
			}
			m.PeerGroupNum = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PeerGroupNum |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
